...
export const RedukuWebView = forwardRef((_, ref) => {
	...
	const handleLoad = (status: string) => {
		setMounted(true);
	...
	const handleLayout = ({ layout }: {layout: any}) => {
	...
	return (
		...
		>
			<RNWebView
				ref={webViewRef}
				source={{
					uri: "https://github.com/GoldinGuy/UltimateRegexResource"
				}}
